...
-- 2. Insert Round of 32 results with 'advanced' team
INSERT INTO round_of_32_results (match_id, team_a, team_b, goals_a, goals_b, advanced)
SELECT DISTINCT ON (rp1.match_id)
    ...
    -- Determine which team advanced by checking who appears in Round of 16
    CASE
        WHEN r16.team IS NOT NULL THEN r16.team
        ELSE CASE
...
LEFT JOIN (
    ...
    WHERE tournament_stage = 'Round of 16'
) r16
  ON r16.team = rp1.team OR r16.team = rp1.opponent_team

-- 1. Drop and recreate the final_result table
...
-- 2. Insert Final Match result
INSERT INTO final_result (match_id, team_a, team_b, goals_a, goals_b, winner)
...
WHERE rp1.tournament_stage = 'Final'
